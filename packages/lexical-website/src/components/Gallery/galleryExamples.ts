...
export const galleryExamples: GalleryExample[] = [
  ...
  },
  {
    ...
    tags: ['opensource', 'favorite', 'collab'],
  ...
  },
  {
    ...
    stackblitzQuery: 'embed=1&file=src%2Fmain.tsx&terminalHeight=0&ctl=0',
    tags: ['opensource', 'extension', 'favorite', 'react'],
  ...
  },
  {
    ...
    tags: ['opensource', 'svelte', 'ssr', 'extension'],
  ...
  },
  {
    ...
    tags: ['opensource', 'vanilla', 'react', 'extension'],
  ...
  },
  {
    ...
    stackblitzQuery: 'embed=1&file=src%2Fmain.ts&terminalHeight=0&ctl=0',
    tags: ['opensource', 'vanilla', 'extension', 'tailwind'],
  ...
  },
  {
    ...
    dir: 'agent-example',
    stackblitzQuery: 'embed=1&file=src%2Fmain.tsx&terminalHeight=0&ctl=0',
    tags: ['opensource', 'extension', 'agent', 'ai', 'react', 'favorite'],
  ...
  },
  {
    ...
    dir: 'website-chat',
    stackblitzQuery: 'embed=1&file=src%2Fmain.tsx&terminalHeight=0&ctl=0',
    tags: ['opensource', 'extension', 'react', 'chat', 'favorite'],
    title: 'Chat',
    viteConfig: 'vite.config.ts',
    waitForSelector: '[data-lexical-editor]',
  },
  {
    ...
    dir: 'website-notion',
    stackblitzQuery: 'embed=1&file=src%2Fmain.tsx&terminalHeight=0&ctl=0',
    tags: ['opensource', 'favorite', 'block', 'react', 'extension'],
  ...
  },
  {
    ...
    stackblitzQuery: 'embed=1&file=src%2Fmain.tsx&terminalHeight=0&ctl=0',
    tags: ['opensource', 'favorite', 'extension', 'simple'],
    title: 'Rich Input',
    viteConfig: 'vite.config.ts',
    waitForSelector: '[data-lexical-editor]',
  },
  {
    ...
    dir: 'website-toolbar',
    stackblitzQuery: 'embed=1&file=src%2Fmain.tsx&terminalHeight=0&ctl=0',
    tags: ['opensource', 'favorite', 'extension', 'toolbar'],
    title: 'Toolbar',
    viteConfig: 'vite.config.ts',
    waitForSelector: '[data-lexical-editor]',
  },
