 ...
 * the right initial value and tagged `data-lexical-slot-editable`. This
 * extension flips those tagged containers whenever {@link
...
export const SlotEditableExtension = /* @__PURE__ */ defineExtension({
  ...
  register: editor =>
    editor.registerEditableListener(editable => {
      ...
      root
        .querySelectorAll<HTMLElement>('[data-lexical-slot-editable]')
        .forEach(container => {
