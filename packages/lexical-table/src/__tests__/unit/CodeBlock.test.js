...
describe('CodeBlock tests', () => {
  initializeUnitTest((testEnv) => {
    ...
    const CODE_PASTING_TESTS = [
      ...
      {
        expectedHTML: `<code spellcheck=\"false\" dir=\"ltr\"><strong data-lexical-text=\"true\">function</strong><span data-lexical-text=\"true\"> run() {</span><br><span data-lexical-text=\"true\">  </span><strong data-lexical-text=\"true\">return</strong><span data-lexical-text=\"true\"> [</span><strong data-lexical-text=\"true\">null</strong><span data-lexical-text=\"true\">, </span><strong data-lexical-text=\"true\">undefined</strong><span data-lexical-text=\"true\">, 2, \"\"];</span><br><span data-lexical-text=\"true\">}</span></code>`,
        name: 'Postman IDE',
