...
import {SharedHistoryContext} from '../../../../../lexical-playground/src/context/SharedHistoryContext';
...
function prepopulatedRichText() {
  ...
  if (root.getFirstChild() === null) {
    ...
    paragraph2.append(
      $createTextNode(
        'In this sample, make sure to check out the images plugin in the toolbar.',
      ),
    );
  }
}
...
export default function ImagePlayground(): JSX.Element {
  return (
    <SettingsContext>
      <App />
      <a
