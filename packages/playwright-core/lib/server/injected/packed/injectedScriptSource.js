          ...
          (t.parseComponentSelector = function (e) {
            ...
            function l() {
              ...
              if (']' === r())
                return (
                  o(),
                  {jsonPath: t, op: '<truthy>', value: null, caseSensetive: !1}
                );
              const c = (function () {
                s();
                let e = '';
            ...
            (e.tokenize = function (e) {
              ...
              for (
                var o,
                  ...
                  ie = function () {
                    for (var e = new F(''); u(X()); ) G();
                    if (Z(X())) return e;
                    for (; G(); ) {
                      if (41 == o || Z()) return e;
                      if (u(o)) {
                        for (; u(X()); ) G();
                        return 41 == X() || Z(X()) ? (G(), e) : (me(), new d());
                      }
              ...
              i = (function () {
                ...
                .map((t) =>
                  a(t, (t) => {
                    ...
                    for (const e of o)
                      if (!(0, r.checkComponentAttribute)(t.props, e))
                        return !1;
                    return !0;
                  }),
                )
        ...
        const o = {
          ...
          p = {
            matches(e, t, n, r) {
              ...
              return (
                'self' === w(r, e, g(t[0], 2 === t.length ? t[1] : void 0))
              );
            },
          },
          f = {
  ...
  (() => {
    ...
    var g = class {
      constructor(e, n, r, s) {
        ...
        for (const {name: e, engine: t} of s) this._engines.set(e, t);
        (this._stableRafCount = e),
          (this._replaceRafWithTimeout = n),
          (this._browserName = r);
      }
      eval(e) {
        return n.g.eval(e);
      ...
      _querySelectorRecursively(e, t, n, r) {
        ...
        if ('visible' === o.name) {
          const t = Boolean(o.body);
          return e.filter((e) => t === (0, c.isVisible)(e.element));
        }
        const i = [];
        for (const o of e) {
      ...
      _createCSSEngine() {
        ...
        return {queryAll: (t, n) => e.query({scope: t, pierceShadow: !0}, n)};
      }
      _createTextEngine(e) {
        const t = (t, n) => {
          ...
          const u = this._evaluator._queryCSS({scope: t, pierceShadow: e}, '*');
        ...
        return this._runAbortableTask((n) => {
          ...
          const i = new Promise((e, t) => {
            ...
            s = () => {
              if (!n.aborted)
                try {
                  const o = Symbol('continuePolling'),
                    i = e(n, o);
                  i !== o ? r(i) : t(s);
                } catch (e) {
                  n.log('  ' + e.message), o(e);
      ...
      waitForElementStatesAndPerformAction(e, t, n, r) {
        let o,
          ...
          c = 0;
        const a = (a, u) => {
          if (n) return a.log('    forcing action'), r(e, a, u);
          for (const n of t) {
            if ('stable' !== n) {
              ...
              if (!t)
                return (
                  a.logRepeating(`    element is not ${n} - waiting...`), u
                );
              continue;
            }
            ...
            if (this._stableRafCount > 1 && r - c < 15) return u;
            c = r;
            const l = t.getBoundingClientRect(),
              h = {x: l.top, y: l.left, width: l.width, height: l.height};
            o &&
            h.x === o.x &&
            h.y === o.y &&
            h.width === o.width &&
            h.height === o.height
              ? ++s
              : (s = 0);
            const p = s >= this._stableRafCount,
              f = p || !o;
            if (
              ((o = h),
              f || a.logRepeating('    element is not stable - waiting...'),
              !p)
            )
              return u;
          }
        ...
        return this._replaceRafWithTimeout
          ? this.pollInterval(16, a)
          : this.pollRaf(a);
      }
      elementState(e, t) {
      ...
      selectOptions(e, t, n, r) {
        const o = this.retarget(t, 'follow-label');
        ...
        return a.length
          ? (n.logRepeating('    did not find some options - waiting... '), r)
          : ((i.value = void 0),
            c.forEach((e) => (e.selected = !0)),
      ...
      expect(e, t, n, r) {
          ...
          i = n.expression;
        {
          ...
          if (void 0 !== n) {
            if ('error:notcheckbox' === n)
              throw o.createStacklessError('Element is not a checkbox');
            if ('error:notconnected' === n)
              throw o.createStacklessError('Element is not connected');
            return {received: n, matches: n};
          }
        }
        if ('to.have.count' === i) {
          const e = r.length;
          return {received: e, matches: e === n.expectedNumber};
        }
        if ('to.have.property' === i) {
          const e = t[n.expressionArg];
          return {received: e, matches: m(e, n.expectedValue)};
        }
        {
          let e;
          if ('to.have.attribute' === i)
            e = t.getAttribute(n.expressionArg) || '';
          else if ('to.have.class' === i) e = t.className;
          else if ('to.have.css' === i)
            e = window.getComputedStyle(t)[n.expressionArg];
          else if ('to.have.id' === i) e = t.id;
          else if ('to.have.text' === i)
            e = n.useInnerText ? t.innerText : t.textContent || '';
          else if ('to.have.title' === i) e = document.title;
          else if ('to.have.url' === i) e = document.location.href;
          else if ('to.have.value' === i) {
            if (
              'INPUT' !== t.nodeName &&
              'TEXTAREA' !== t.nodeName &&
              'SELECT' !== t.nodeName
        ...
        }
        {
          let e;
          if (
            ('to.have.text.array' === i || 'to.contain.text.array' === i
              ? (e = r.map((e) =>
                  n.useInnerText ? e.innerText : e.textContent || '',
                ))
              : 'to.have.class.array' === i && (e = r.map((e) => e.className)),
            e && n.expectedText)
          ) {
            const t = 'to.contain.text.array' !== i;
            if (e.length !== n.expectedText.length && t)
              return {received: e, matches: !1};
            let r = 0;
            const o = n.expectedText.map((e) => new d(e));
            let s = !0;
            for (const t of o) {
              for (; r < e.length && !t.matches(e[r]); ) r++;
              if (r >= e.length) {
                s = !1;
                break;
              }
            }
            return {received: e, matches: s};
          }
        }
        throw this.createStacklessError(
          'Unknown expect matcher: ' + n.expression,
        );
      }
    };
    e.default = g;
