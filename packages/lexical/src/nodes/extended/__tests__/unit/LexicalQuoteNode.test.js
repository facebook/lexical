  ...
  initializeUnitTest((testEnv) => {
    ...
    test('QuoteNode.insertNewAfter()', async () => {
      ...
      expect(testEnv.outerHTML).toBe(
        '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><blockquote><br></blockquote></div>',
      );
      await editor.update(() => {
      ...
      expect(testEnv.outerHTML).toBe(
        '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><blockquote><br></blockquote><p><br></p></div>',
      );
    });
