<h1 align="center">README.md 
  <a href="https://lexical.dev">Lexical</a>
</h1> 
مشروع برمجي عربي يُدار ويُطوّر بواسطة **Nora (nenora.com)**
يهدف إلى بناء أدوات وتجارب لغوية وتقنية تعكس الهوية والوكالة الرقمية.

---

## 🎯 الهدف
- تقديم بيئة تجريبية للبرمجة باللغة العربية.
- تطوير مكتبات وأدوات تساعد على معالجة النصوص والبيانات بشكل مبسط وموثوق.
- دمج الجانب الرمزي (اللغة والهوية) مع الجانب العملي (الكود والبرمجة).

---

## 📂 هيكل المشروع
- `أمثلة` : أمثلة عملية للتجربة والتطبيق.
- `نوع البيانات` : تعريفات وأنواع مخصصة للمعالجة.
- `libdefs` : مكتبات أساسية.
- `نصوص` : أدوات التعامل مع النصوص.
