  ...
  describe('Block selection moves when new nodes are inserted', () => {
    [
      // Collapsed selection on end; add/remove/replace beginning
      {
        ...
        focusOffset: 2,
        fn: (paragraph, text) => {
          const newText = otlnCreateTextNode('2');
      ...
      },
      {
        ...
        focusOffset: 1,
        fn: (paragraph, text) => {
          const newText = otlnCreateTextNode('replacement');
      ...
      // Selection beginning; add/remove/replace on end
      {
        ...
        fnBefore: (paragraph, originalText1) => {
          const originalText2 = otlnCreateTextNode('bar');
      ...
      // Edge cases
      {
        ...
        fn: (paragraph, originalText1) => {
          ...
          const newText = otlnCreateTextNode('new');
