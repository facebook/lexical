  ...
  initializeUnitTest((testEnv) => {
    ...
    test('HeadingNode.insertNewAfter()', async () => {
      ...
      expect(testEnv.outerHTML).toBe(
        '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><h1><br></h1></div>',
      );
      await editor.update(() => {
      ...
      expect(testEnv.outerHTML).toBe(
        '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><h1><br></h1><p><br></p></div>',
      );
    });
    ...
    test('creates a h2 with text and can insert a new paragraph after', async () => {
      ...
      expect(testEnv.outerHTML).toBe(
        `<div contenteditable=\"true\" style=\"user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;\" data-lexical-editor=\"true\"><h2 dir=\"ltr\"><span data-lexical-text=\"true\">${text}</span></h2></div>`,
      );
      await editor.update(() => {
        const result = headingNode.insertNewAfter();
        expect(result).toBeInstanceOf(ParagraphNode);
      ...
      expect(testEnv.outerHTML).toBe(
        `<div contenteditable=\"true\" style=\"user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;\" data-lexical-editor=\"true\"><h2 dir=\"ltr\"><span data-lexical-text=\"true\">${text}</span></h2><p><br></p></div>`,
      );
    });
  });
});
