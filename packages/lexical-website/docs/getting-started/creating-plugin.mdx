...
extension below adds the image through `DOMRenderExtension.$decorateDOM`, which
only runs for the live editor. Copying or exporting HTML preserves the Unicode
text and formatting without loading images or including emoji-specific classes
...
Define the transform and live DOM decoration in the extension:
