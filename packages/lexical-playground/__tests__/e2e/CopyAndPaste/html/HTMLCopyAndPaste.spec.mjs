...
test.describe('HTML CopyAndPaste', () => {
  ...
  test('Copy + paste a code block with BR', async ({page, isPlainText}) => {
    ...
    const clipboard = {
      'text/html': `<meta charset='utf-8'><p class="x1f6kntn x1fcty0u x16h55sf x12nagc xdj266r" dir="ltr"><span>Code block</span></p><code class="x1f6kntn x1fcty0u x16h55sf x1xmf6yo x1e56ztr x1q8sqs3 xeq4nuv x1lliihq xz9dl7a xn6708d xsag5q8 x1ye3gou" spellcheck="false" data-language="javascript" data-highlight-language="javascript" data-lexical-code-gutter-active="true"><span class="xuc5kci" data-line-number="1">function</span><span> </span><span class="xu88d7e">foo</span><span class="x1noocy9">(</span><span class="x1noocy9">)</span><span> </span><span class="x1noocy9">{</span><span data-lexical-code-linebreak-wrap="true" class="code-linebreak-wrap"><br></span><span data-line-number="2">  </span><span class="xuc5kci">return</span><span> </span><span class="x180nigk">'Hey there'</span><span class="x1noocy9">;</span><span data-lexical-code-linebreak-wrap="true" class="code-linebreak-wrap"><br></span><span class="x1noocy9" data-line-number="3">}</span></code><p class="x1f6kntn x1fcty0u x16h55sf x12nagc xdj266r" dir="ltr"><span>--end--</span></p>`,
    };
