...
import {LinkNode, otlnCreateLinkNode, isLinkNode} from 'outline/LinkNode';
...
describe('OutlineLinkNode tests', () => {
  initializeUnitTest((testEnv) => {
    ...
    test('otlnCreateLinkNode()', async () => {
      const {editor} = testEnv;
      await editor.update(() => {
        const linkNode = new LinkNode('https://example.com/foo');
        const createdLinkNode = otlnCreateLinkNode('https://example.com/foo');
