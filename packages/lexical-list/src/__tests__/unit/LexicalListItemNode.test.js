  ...
  initializeUnitTest((testEnv) => {
    ...
    describe('ListItemNode.replace()', () => {
      ...
      test('first list item with a non list item node', async () => {
        ...
        expect(testEnv.outerHTML).toBe(
          '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><span data-lexical-text="true">bar</span><ul><li value="1" dir="ltr"><span data-lexical-text="true">two</span></li><li value="3" dir="ltr"><span data-lexical-text="true">three</span></li></ul></div>',
        );
      });
      ...
      test('last list item with a non list item node', async () => {
        ...
        expect(testEnv.outerHTML).toBe(
          '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><ul><li value="1" dir="ltr"><span data-lexical-text="true">one</span></li><li value="2" dir="ltr"><span data-lexical-text="true">two</span></li></ul><span data-lexical-text="true">bar</span></div>',
        );
      });
      ...
      test('middle list item with a non list item node', async () => {
        ...
        expect(testEnv.outerHTML).toBe(
          '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><ul><li value="1" dir="ltr"><span data-lexical-text="true">one</span></li></ul><span data-lexical-text="true">bar</span><ul><li value="1" dir="ltr"><span data-lexical-text="true">three</span></li></ul></div>',
        );
      });
      ...
      test('the only list item with a non list item node', async () => {
        ...
        expect(testEnv.outerHTML).toBe(
          '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><ul><li value="1" dir="ltr"><span data-lexical-text="true">one</span></li></ul></div>',
        );
        await editor.update(() => {
          const textNode = new TextNode('bar');
          listItemNode1.replace(textNode);
        ...
        expect(testEnv.outerHTML).toBe(
          '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><span data-lexical-text="true">bar</span></div>',
        );
      });
    });
    ...
    describe('ListItemNode.insertNewAfter(): non-empty list items', () => {
      ...
      test('the only list item', async () => {
        ...
        expect(testEnv.outerHTML).toBe(
          '<div contenteditable="true" style="user-select: text; white-space: pre-wrap; overflow-wrap: anywhere;" data-lexical-editor="true"><ul><li value="1" dir="ltr"><span data-lexical-text="true">one</span></li><li value="2"><br></li></ul></div>',
        );
      });
    });
