  ...
  var e = {
      ...
      7994: (e, n, t) => {
        ...
        n.Recorder = ({
          ...
          var d;
          const [f, p] = r.useState(s || ''),
            [b, g] = r.useState(!1);
          window.playwrightSetSelector = (e, n) => {
            p(e), g(!!n);
          };
          const [h, m] = r.useState();
          window.playwrightSetFile = m;
          const v =
              h || (null === (d = e[0]) || void 0 === d ? void 0 : d.file),
            y = e.find((e) => e.file === v) || {
              text: '',
              language: 'javascript',
              file: '',
          ...
          return (
            r.useLayoutEffect(() => {
              b && E.current && (E.current.select(), E.current.focus(), g(!1));
            }, [b, E]),
            r.createElement(
              'div',
              {className: 'recorder'},
              r.createElement(
                ...
                r.createElement(
                  'select',
                  {
                    ...
                    value: v,
                    onChange: (e) => {
                      m(e.target.selectedOptions[0].value);
                    },
                  },
                  e.map((e) => {
