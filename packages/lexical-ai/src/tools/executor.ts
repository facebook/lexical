...
/**
 * Create a ToolExecutor bound to a Lexical editor instance.
 * All tool operations execute directly in the browser via editor.update/read.
 */
...
/**
 * Split a text node at a given offset to isolate a substring,
 * returning references to the before, target, and after parts.
 */
