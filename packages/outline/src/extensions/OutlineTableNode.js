  ...
  tableElement.addEventListener('mousedown', (event: MouseEvent) => {
    ...
    if (cell !== null) {
      ...
      const removeListeners = [
        editor.addListener('deleteCharacter', () => {
          if (isHighlightingCells) {
            editor.update(() => {
              ...
              highlightedCells.forEach((highlightedCell) => {
                const cellNode = getNearestNodeFromDOMNode(
                  highlightedCell.elem,
                );
        ...
        editor.addListener('formatText', (type) => {
          if (isHighlightingCells) {
            editor.update(() => {
