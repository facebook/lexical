    ...
    (testEnv) => {
      ...
      test('Copy table from an external source', async () => {
        ...
        expect(testEnv.innerHTML).toBe(
          `<div class="lexical-scrollable" style="overflow-x: auto;"><table><colgroup><col style="width: 100px;"><col style="width: 100px;"></colgroup><tr><td><p dir="ltr"><span data-lexical-text="true">Hello there</span></p></td><td><p dir="ltr"><span data-lexical-text="true">General Kenobi!</span></p></td></tr><tr><td><p dir="ltr"><span data-lexical-text="true">Lexical is nice</span></p></td><td><p><br></p></td></tr></table></div>`,
        );
      });
