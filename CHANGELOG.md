...
- Iterate through the live NodeList instead of copying to an array in  (#4164) Acy Watson
...
- Use broader return types in  (#4097) Chris Montrois
...
- Fixed reference to old  method in transforms doc (#4094) Kevin Ansfield
...
- chore: prevent action from running on forks (#4068) 子瞻 Luci
- Removed additional FloatingLinkEditorPlugin mouse listeners (#4057) Brandon
- Fixed invalid property value for EquationEditor_blockEditor (#4062) Brandon
- deprecate  (#4059) Acy Watson
...
- Add  method on LexicalNode to fix copy/paste issues with clipboard (#3800) John Flockton
...
- Fix  with a custom selection passed in (#3749) William Wang
...
- Remove preventDefault from  (#3742) John Flockton
...
- Add missing usages of  (#3592) John Flockton
...
- check read only flag during  (#3572) yf-yang
...
- Add  back to flow (#3551) Acy Watson
...
- Various fixes in  (#3234) EgonBolton
...
- ⏸ [0.7] Remove  (#3483) Dominic Gannaway
...
- Add  to <button /> components (#3447) Scott Agirs
...
-  &  for root selection (#3442) Maksim Horbachevsky
...
- Fix  Flow type (#3411) Gerard Rovira
...
- Fix bad selection on  (#3400) Dominic Gannaway
...
- Improve  (#3344) Maksim Horbachevsky
- Add  &  (#3342) Maksim Horbachevsky
...
- fix: align center fill caret icon on  (#3304) Nguyen Cao Cuong - Peter James
