...
import {PlainTextExtension} from '../../index';

describe('PlainTextExtension normalizeInlineElements', () => {
  test('should remove empty inline elements by default', async () => {
    using editor = buildEditorFromExtensions({
      ...
      dependencies: [configExtension(PlainTextExtension)],
      name: 'test',
  ...
  test('should not to remove empty inline elements if normalizeInlineElements is disabled', async () => {
    using editor = buildEditorFromExtensions({
      ...
      dependencies: [
        configExtension(PlainTextExtension, {normalizeInlineElements: false}),
      ],
      name: 'test',
      nodes: [TestInlineElementNode],
    });
